...
Production deployment steps, environment variables, health checks, smoke tests, monitoring, and security review are documented in [docs/deployment.md](docs/deployment.md). Keep provider credentials, demo credentials, and production secrets in the hosting dashboard or a secret manager, never in this repository.
