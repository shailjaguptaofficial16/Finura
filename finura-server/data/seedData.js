...
const seedTransactions = [
  ...
  {
    title: 'Health Insurance Premium', amount: 1250, type: 'expense', category: 'Healthcare', date: new Date('2026-08-20'), description: 'Annual health cover installment',
  },
  {
    title: 'Metro and Cab Travel', amount: 620, type: 'expense', category: 'Transport', date: new Date('2026-08-22'), description: 'Commuting and client meetings',
  },
  {
    title: 'Dividend Distribution', amount: 980, type: 'income', category: 'Investments', date: new Date('2026-08-25'), description: 'Quarterly equity dividend',
  },
  {
    title: 'Streaming and Software', amount: 899, type: 'expense', category: 'Entertainment', date: new Date('2026-08-28'), description: 'Professional and personal subscriptions',
  },
];
